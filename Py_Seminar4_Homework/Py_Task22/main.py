...
# result = list_a.intersection(list_b)  # Автоматически сортирует множество.
result = list(list_a & list_b)  # Пересечение множеств.
print(result)
...
# mol = [x for x in input().split()]  # Эталонное решение.
# n = mol[0]
# m = mol[1]
# set_1 = set()
# set_2 = set()
...
# a = [RD(0,100) for _ in range(n)]n = int(input("Введите количество элементов 2 массива : "))
# b = [RD(0,100) for _ in range(n)]print("Массив состоит из: ", *a)
