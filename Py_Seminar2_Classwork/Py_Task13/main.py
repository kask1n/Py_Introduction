...
# for i in range(n):  # [0, n). Решение без массива через один цикл (автоматическое заполнение и подсчёт).
...
statistics = []
for i in range(n):  # [0, n). Решение с массивом через два цикла (заполнение вручную).
