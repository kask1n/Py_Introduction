...
van1 = int(input("Введите номер i-го вагона от головы поезда: "))
van2 = int(input("Введите номер j, который написан на вагоне: "))

if van1 == van2:
    print("-> Без дополнительной информации это сделать невозможно.")
else:
    print(f"-> Количество вагонов в поезде: {van1 + van2 - 1}")
